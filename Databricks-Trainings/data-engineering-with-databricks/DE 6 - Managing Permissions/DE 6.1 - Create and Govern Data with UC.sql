...
-- REVOKE USAGE ON SCHEMA example FROM `account users`;
-- REVOKE SELECT ON VIEW agg_heartrate FROM `account users`
...
SELECT * FROM meet_marcin_bu9m_da.example.agg_heartrate
